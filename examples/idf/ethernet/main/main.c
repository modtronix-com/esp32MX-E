...
void app_main() {
	...
	// Put PHY in reset
//	gpio_pad_select_gpio(PHY_RESET);
//  gpio_set_direction(PHY_RESET, GPIO_MODE_OUTPUT);
//  gpio_set_level(PHY_RESET, 0);
...
//    // Enable Oscillator
//    gpio_pad_select_gpio(PHY_OSC_ENABLE);
//    gpio_set_direction(PHY_OSC_ENABLE, GPIO_MODE_OUTPUT);
//    gpio_set_level(PHY_OSC_ENABLE, 0);	// DO NOT ENABLE OSC! Not currently used !!!!!!!!!!!!!!!!!!!!!!!
//    //vTaskDelay(200 / portTICK_PERIOD_MS);

    // Enable PHY on esp32MX-E Board
//	gpio_pad_select_gpio(PHY_RESET);
//	gpio_set_direction(PHY_RESET, GPIO_MODE_OUTPUT);
//	gpio_set_level(PHY_RESET, 1);
//	vTaskDelay(100 / portTICK_PERIOD_MS);

//	vTaskDelay(500 / portTICK_PERIOD_MS);

	// TEST TEST - Toggle GPIO0 at about 2.5MHz
